...
// import "./Css/ViewAppointment.css"; // Custom CSS file

// const ViewAppointment = ({ loggedInUser }) => {
//   const {
//     appointments,
//     deleteAppointment,
//     updateAppointment,
...
//       if (loggedInUser?._id) {
//         try {
//           await fetchUserAppointments(loggedInUser._id);
//         } catch (error) {
...
//     try {
//       await updateAppointment(formData); // Pass updated formData
//       setAlert({
//         show: true,
...
//         {/* Appointment Table */}
//         <Table striped bordered hover responsive="sm" className="appointment-table">
//           <thead>
//             <tr>
//               <th>#</th>
//               <th>Patient Name</th>
